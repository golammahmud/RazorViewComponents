...
namespace BeratenKatuwahDataAccess
{
    public abstract class BaseDataManager
    {
        ...
        private ApplicationDbContexts dbModel;
        public BaseDataManager(ILogger<IndexModel> logger, ApplicationDbContexts model)
        {
            this._logger = logger;
            this.dbModel = model;
        }
        ...
        protected bool RemoveRange<T>(List<T> entities, bool keepDettached = true) where T : class
        {
            try
            {
